...
- `read_csv()` is for comma-separated values (CSV), while `read_csv2()` is 
   used for semicolon-separated values with `,` as the decimal mark.
...
3. Inspecting the imported data

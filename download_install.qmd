...
The RStudio IDE can be obtained from the “Download” section of the Posit [website](https://posit.co/download/rstudio-desktop/). Install the software by clicking on the “Download RStudio Desktop for Windows” button and running the downloaded program (Figure …).

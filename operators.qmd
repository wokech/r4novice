...
- Logical,
- Assignment, and
- Miscellaneous. **Cross-ref**

### Arithmetic Operators

Arithmetic operators are used to perform mathematical operations. These operators were reviewed in the previous lesson **Cross-Ref**
...
NOTE: 
Full discussion on vectors in the chapter **Cross-Ref**
...
These operators assign values to variables. A more comprehensive review can be obtained in the lesson **Cross-ref**

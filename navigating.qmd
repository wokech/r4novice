...
![The R Console](images/navigating/r_console_1.png)

### RStudio interface (Menu Options)

The RStudio interface has a number of menu bar options (@fig-rstudio-console-1). To orient the user, a brief description of each menu bar option has been provided below.

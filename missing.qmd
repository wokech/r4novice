...
- `NaN` = impossible values `Inf` = infinite value obtained by dividing by zero (is.infinite() identifies an infinite value and as.infinite() converts to an infinite value).
